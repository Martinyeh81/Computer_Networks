...
#define PORT 21961 //8140821161 (21800 + 161)
...
void send(){
    ...
    string totalinfo = "";
    vector<string> data = read_hospital("/Users/martinyeh/Desktop/EE450/project/student5.txt");
...
void receive_result() {
    ...
    printf("<Student5> has received the application result is %s\n", finalresult.c_str());
