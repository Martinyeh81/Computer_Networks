...
#define PORT 21861 //8140821161 (21700 + 161)
...
void send(){
    ...
    string totalinfo = "";
    vector<string> data = read_hospital("/Users/martinyeh/Desktop/EE450/project/student4.txt");
...
void receive_result() {
    ...
    printf("<Student4> has received the application result is %s\n", finalresult.c_str());
