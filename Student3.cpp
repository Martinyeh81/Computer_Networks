...
#define PORT 21761 //8140821161 (21600 + 161)
...
void send(){
    ...
    string totalinfo = "";
    vector<string> data = read_hospital("/Users/martinyeh/Desktop/EE450/project/student3.txt");
...
void receive_result() {
    ...
    printf("<Student3> has received the application result is %s\n", finalresult.c_str());
